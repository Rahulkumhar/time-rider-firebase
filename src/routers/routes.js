...
// time rider //
const RiderList = React.lazy (() => import('../components/Rider/RiderList'));
const RiderDetails = React.lazy (() => import('../components/Rider/RiderDetails'));
...
const routes = [
  ...
  // { path: '/rider', name: 'Rider', component: Dashboard },
  // { path: '/driver', name: 'Driver', component: Dashboard },
